...
Test-File "docker-compose.yml" "Docker Compose file exists"
Test-Content "docker-compose.yml" "Dockerfile.lenient" "Docker Compose uses lenient build"

Write-Host "`nFile Structure Tests:" -ForegroundColor Yellow
Test-File "frontend/src/app/services/auth.service.ts" "Auth service exists"
Test-File "frontend/src/app/services/quiz.service.ts" "Quiz service exists"
